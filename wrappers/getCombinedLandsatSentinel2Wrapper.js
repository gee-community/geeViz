...
var studyArea = ee.FeatureCollection('projects/Sacha/Ecuador_nxprovincias').bounds();//geometry;
...
createAndExportComposites(ls,1999,2000,1,365,1,[1,3,1],365,'projects/Sacha/L8/L8_Annual_Updated','Landsat',lExportBands,['temp','count'],scale,crs,null);
