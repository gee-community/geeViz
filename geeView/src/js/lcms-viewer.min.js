...
if(needsUpdated){$("#post-years-slider").slider("value",urlParams.postYear);$("#post-years-slider-update").html(`${urlParams.postYear}`);}});addCollapse("sidebar-left","layer-list-collapse-label","layer-list-collapse-div","MAP LAYERS",`<img style = 'width:1.1em;' class='image-icon mr-1' alt="Layers icon" src="./src/assets/images/layer_icon.png">`,true,null,mode+" DATA layers to view on map");addCollapse("sidebar-left","reference-layer-list-collapse-label","reference-layer-list-collapse-div","REFERENCE DATA",`<img class='panel-title-svg-lg'  alt="Layers icon" src="./src/assets/Icons_svg/data-layers_ffffff.svg">`,false,null,"Additional relevant layers to view on map intended to provide context for change data");$("#reference-layer-list-collapse-div").append(`<ul id="reference-layer-list" class = "layer-list"></ul>`);addCollapse("sidebar-left","tools-collapse-label","tools-collapse-div","TOOLS",`<i role="img" class="fa fa-gear mr-1" aria-hidden="true"></i>`,false,"","Tools to measure and chart data provided on the map");addCollapse("sidebar-left","support-collapse-label","support-collapse-div","SUPPORT",`<img class='panel-title-svg-lg'  alt="Support icon" src="./src/assets/Icons_svg/support_ffffff.svg">`,true,``,"If you need any help");$("#support-collapse-div").append(staticTemplates.sequoiaSupportDiv);$("#layer-list-collapse-div").append(`<ul id="layer-list" class = "layer-list"></ul>`);$("#parameters-collapse-div").append(staticTemplates.reRunButton);if(urlParams.canExport===true){canExport=urlParams.canExport;addCollapse("sidebar-left","download-collapse-label","download-collapse-div","DOWNLOAD DATA",`<i role="img" class="fa fa-cloud-download mr-1" aria-hidden="true"></i>`,false,``,"Download "+mode+" products for further analysis");}}else{addCollapse("sidebar-left","layer-list-collapse-label","layer-list-collapse-div","ANCILLARY DATA",`<img style = 'width:1.1em;' class='image-icon mr-1' alt="Layers icon" src="./src/assets/images/layer_icon.png">`,true,null,mode+" DATA layers to view on map");addCollapse("sidebar-left","wayback-layer-list-collapse-label","wayback-layer-list-collapse-div","ESRI WayBack DATA",`<img style = 'width:1.1em;' class='image-icon mr-1' alt="Layers icon" src="./src/assets/images/esri-logo.png">`,true,null,"ESRI Wayback layers to view on map");addCollapse("sidebar-left","reference-layer-list-collapse-label","reference-layer-list-collapse-div","PLOT DATA",`<img style = 'width:1.1em;' class='image-icon mr-1' alt="Layers icon" src="./src/assets/images/layer_icon.png">`,false,null,"Additional relevant layers to view on map intended to provide context for "+mode+" DATA");addCollapse("sidebar-left","tools-collapse-label","tools-collapse-div","TOOLS",`<i role="img" class="fa fa-gear mr-1" aria-hidden="true"></i>`,false,"","Tools to measure and chart data provided on the map");$("#layer-list-collapse-div").append(`<ul id="layer-list" class = "layer-list"></ul>`);$("#wayback-layer-list-collapse-div").append(`<ul id="wayback-layer-list" class = "layer-list"></ul>`);$("#wayback-layer-list-collapse-div").append(`<div id = 'wayback-metadata-loading' style='display:none;'>
    ...
    `);$("#reference-layer-list-collapse-div").append(`<ul id="reference-layer-list" class = "layer-list"></ul>`);plotsOn=true;}
...
viz.dictServerSide=viz.dictServerSide!==undefined?viz.dictServerSide:true;if(viz.layerType!=="tileMapService"&&(viz.eeObjInfo===undefined||viz.eeObjInfo===null)){viz.eeObjInfo=getImagesLib.eeObjInfo(item,"ImageCollection");}else if(viz.layerType!=="tileMapService"&&viz.dictServerSide===true){viz.eeObjInfo=ee.Dictionary(viz.eeObjInfo);}
...
viz=addClassVizDicts(viz);console.log(viz);}
...
this.updateProgress();selectedChartObjs.map((selectedObj)=>{let scaleT=structuredClone(selectedObj.scale);let transformT=structuredClone(selectedObj.transform);let scaleMult=1;let nominalScale=scaleT||transformT[0];let divWidth=$("#legendDiv").width()-convertRemToPixels(2);this.chartWidth=selectedObj.chartWidth||divWidth;this.chartHeight=selectedObj.chartHeight||parseInt(divWidth*0.7);if(selectedObj.autoScale){let scaleTransform=this.autoSetScale(scaleT,transformT,selectedObj.minZoomSpecifiedScale,selectedObj.maxAutoScale);scaleT=scaleTransform[0];transformT=scaleTransform[1];scaleMult=scaleTransform[2];nominalScale=scaleTransform[3];}
