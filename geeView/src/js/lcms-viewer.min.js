...
function chartCacheduserSelectedAreaChartingAOIs(){if(urlParams.userSelectedAreaChartingAOIs!==undefined&&urlParams.userSelectedAreaChartingAOIs!==null&&urlParams.userSelectedAreaChartingAOIs.length>0){urlParams.userSelectedAreaChartingAOIs.map((l)=>{let selectedFeaturesT=selectedFeaturesJSON[l[0]].eeObject.filter(ee.Filter.inList("system:index",l[1]));addSelectedFeaturesToMapWrapper(selectedFeaturesT,l[2],l[0]);});updateSelectedAreasNameList();updateSelectedAreaArea();if(getActiveTools()[0]==="Area Tools-Select an Area on map"){chartSelectedAreas(false);}}}
