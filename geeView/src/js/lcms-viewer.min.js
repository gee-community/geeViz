...
window.location.pathname+
constructUrlSearch();}
let fullShareURL;const tiny_json_url="https://tiny-json-4539853f6a69.herokuapp.com";function storeParams(showSpinner=true,showPopup=true){const store_api=`${tiny_json_url}/store`;if(showSpinner===true){setTimeout(()=>Map.showSpinner(),100);}
urlParams.expectedCode=getCode();let res=$.ajax({type:"POST",url:store_api,async:false,data:JSON.stringify(urlParams),contentType:"application/json; charset=utf-8",});if(res.statusText==="OK"){let id=res.responseText;console.log(id);fullShareURL=`${baseUrl()}?id=${id}`;setUrl(fullShareURL);copyToClipBoard(fullShareURL,showPopup);}
      ...
      <div id = 'dashboard-results-div'>
        ...
        <i  onclick='clearAllSelectedDashboardFeatures()' id='erase-all-dashboard-selected' title="Click to clear all selected features from this layer" class="fa fa-eraser eraser-all" ></i>
    					...
    					<select class="form-control" id = "downloadDropdown" onchange = "downloadSelectedArea()""></select>
                                        ...
                                        </ul>`,TreeMapGEEClippingDiv:`<div class='hl'></div><h4 class='pt-2' id = 'data-clipping-header' title = 'Choose layers to clip and download'>Data Clipping</h4>`,TreeMapDownloadDiv:`<h4 id = 'treemap-conus-download-header' class='pt-2'>CONUS Datasets</h4>
...
function addClassLegendContainer(classLegendContainerID,legendContainerID,classLegendTitle,obj){$("#"+legendContainerID).append(`<div class='my-legend'>
...
if(tSummaryMethod==="prob"){$("#summaryMethod-radio-second_toggle_label").click();}
